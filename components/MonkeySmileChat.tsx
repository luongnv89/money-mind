  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      role: 'assistant',
      content:
        "Hey! I'm MonkeySmile 🐵. Ask me anything about your budget. Try 'Can I afford pizza?' or 'Roast my spending'.",
      timestamp: Date.now(),
    },
  ]);
            ...
            <div className="p-3 bg-white border-t border-gray-100 shrink-0">
              {!isAIReady ? (
                <div className="text-center p-2 space-y-2">
                  <p className="text-xs text-gray-500">Connect AI to chat with your data.</p>
                  <Button
                    size="sm"
                    variant="outline"
              ...
              <form
                ...
                className={cn(
                  ...
                  !isAIReady && 'opacity-50 pointer-events-none'
                )}
              >
                <Input
                  value={inputValue}
