            ...
            <CardContent className="p-6 pt-2">
                <div className="flex flex-col md:flex-row gap-8 items-center">
                    ...
                    <div className="flex flex-col items-center justify-center shrink-0">
                        <div className="relative w-40 h-40 flex items-center justify-center">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center">
                                <span className={cn("text-4xl font-extrabold tracking-tight", 
                                    score >= 80 ? "text-emerald-600" : score >= 60 ? "text-amber-600" : "text-red-600"
                                )}>
                                    {displayScore}
                                </span>
                                <span className="text-xs font-semibold text-gray-400 uppercase tracking-wide mt-1">/ 100</span>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 w-full space-y-4">
                        <div>
                             <h4 className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">Score Factors</h4>
                                    ...
                                    <div key={idx} className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 transition-colors border border-transparent hover:border-gray-100">
                                        <div className="flex items-center gap-3">
                                            <div className={cn("p-1.5 rounded-md", 
                                                ...
                                                item.type === 'negative' ? "bg-red-100 text-red-600" : "bg-gray-100 text-gray-500"
                                            )}>
                                                {item.type === 'positive' ? <CheckCircle2 className="w-3.5 h-3.5" /> :
                                                 item.type === 'negative' ? <AlertCircle className="w-3.5 h-3.5" /> :
                                        ...
                                        <div className={cn(
                                            ...
                                            item.points < 0 ? "text-red-600" : "text-gray-400"
                                        )}>
                         ...
                         <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-xl p-4 border border-indigo-100 h-full flex flex-col justify-center relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-xs font-bold text-indigo-800 uppercase tracking-wide">Top Tip</span>
                                </div>
